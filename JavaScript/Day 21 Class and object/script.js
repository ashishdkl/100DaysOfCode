...
class FirstClass {
  firstFunctionOfClass() {
    // we don't use function keyword while creating method inside the class.
    console.log("My name is");
  }

  secondFunctionOfClass(name, age, address, subject) {
    console.log(
      `My name is ${name}, i am ${age} years old i live in ${address}, and my major subject is ${subject}`,
    );
  }
}
...
// One of the importante keyword is  this
// this refers to the current object. this = current object
